...
<body class="vertical-layout vertical-menu-modern 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
                                    ...
                                    <table id="recent-orders" class="table table-hover table-xl mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-truncate">
                                                    <span class="avatar avatar-xs">
                                                        <img class="box-shadow-2" src="{{ asset('app-assets/images/portrait/small/avatar-s-4.png') }}" alt="avatar">
                                                    </span>
                                                ...
                                                <td class="text-truncate p-1">
                                                    <ul class="list-unstyled users-list m-0">
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Kimberly Simmons" class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="{{ asset('app-assets/images/portfolio/portfolio-1.jpg') }}" alt="Avatar">
                                                        </li>
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Willie Torres" class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="{{ asset('app-assets/images/portfolio/portfolio-2.jpg') }}" alt="Avatar">
                                                        </li>
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Rebecca Jones" class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="{{ asset('app-assets/images/portfolio/portfolio-4.jpg') }}" alt="Avatar">
                                                        </li>
                                                        <li class="avatar avatar-sm">
                                                            <span class="badge badge-info">+1 more</span>
                                                        </li>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-truncate">
                                                    <span class="avatar avatar-xs">
                                                        <img class="box-shadow-2" src="{{ asset('app-assets/images/portrait/small/avatar-s-5.png') }}" alt="avatar">
                                                    </span>
                                                    <span>Doris R.</span>
                                                </td>
                                                <td class="text-truncate p-1">
                                                    <ul class="list-unstyled users-list m-0">
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Kimberly Simmons" class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="{{ asset('app-assets/images/portfolio/portfolio-5.jpg') }}" alt="Avatar">
                                                        </li>
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Willie Torres" class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="{{ asset('app-assets/images/portfolio/portfolio-6.jpg') }}" alt="Avatar">
                                                        </li>
                                                        <li class="avatar avatar-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-truncate">
                                                    <span class="avatar avatar-xs">
                                                        <img class="box-shadow-2" src="{{ asset('app-assets/images/portrait/small/avatar-s-6.png') }}" alt="avatar">
                                                    </span>
                                                    <span>Megan S.</span>
                                                </td>
                                                <td class="text-truncate p-1">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-truncate">
                                                    <span class="avatar avatar-xs">
                                                        <img class="box-shadow-2" src="{{ asset('app-assets/images/portrait/small/avatar-s-7.png') }}" alt="avatar">
                                                    </span>
                                                    <span>Andrew D.</span>
                                                </td>
                                                <td class="text-truncate p-1">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-truncate">
                                                    <span class="avatar avatar-xs">
                                                        <img class="box-shadow-2" src="{{ asset('app-assets/images/portrait/small/avatar-s-9.png') }}" alt="avatar">
                                                    </span>
                                                    <span>Walter R.</span>
                                                </td>
                                                <td class="text-truncate p-1">
                                                    <ul class="list-unstyled users-list m-0">
                                                        ...
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Willie Torres" class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="{{ asset('app-assets/images/portfolio/portfolio-3.jpg') }}" alt="Avatar">
                                                        </li>
                                                    </ul>
                                                </td>
                                                <td>
                ...
                <div class="row match-height">
                    <div class="col-xl-4 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <img class="img-fluid" src="{{ asset('app-assets/images/carousel/05.jpg') }}" alt="Card image cap">
                                <div class="card-body">
                                                ...
                                                <ol>
                                                        ...
                                                        <blockquote class="blockquote border-0">
                                                            <div class="media">
                                                                <div class="media-left">
                                                                    <img class="media-object img-xl mr-1" src="{{ asset('app-assets/images/portrait/small/avatar-s-5.png') }}" alt="Generic placeholder image">
                                                                </div>
                                                                <div class="media-body">
                                                    ...
                                                    <li data-date="28/02/2015">
                                                        <blockquote class="blockquote border-0">
                                                            <div class="media">
                                                                <div class="media-left">
                                                                    <img class="media-object img-xl mr-1" src="{{ asset('app-assets/images/portrait/small/avatar-s-6.png') }}" alt="Generic placeholder image">
                                                                </div>
                                                                <div class="media-body">
                                                                    Sometimes life is going to hit you in the head with a brick. Don't lose faith.
                                                                </div>
                                                    ...
                                                    <li data-date="20/04/2015">
                                                        <blockquote class="blockquote border-0">
                                                            <div class="media">
                                                                <div class="media-left">
                                                                    <img class="media-object img-xl mr-1" src="{{ asset('app-assets/images/portrait/small/avatar-s-7.png') }}" alt="Generic placeholder image">
                                                                </div>
                                                                <div class="media-body">
                                                                    Sometimes life is going to hit you in the head with a brick. Don't lose faith.
                                                                </div>
                                                    ...
                                                    <li data-date="20/05/2015">
                                                        <blockquote class="blockquote border-0">
                                                            <div class="media">
                                                                <div class="media-left">
                                                                    <img class="media-object img-xl mr-1" src="{{ asset('app-assets/images/portrait/small/avatar-s-8.png') }}" alt="Generic placeholder image">
                                                                </div>
                                                                <div class="media-body">
                                                                    Sometimes life is going to hit you in the head with a brick. Don't lose faith.
                                                                </div>
                                                    ...
                                                    <li data-date="09/07/2015">
                                                        <blockquote class="blockquote border-0">
                                                            <div class="media">
                                                                <div class="media-left">
                                                                    <img class="media-object img-xl mr-1" src="{{ asset('app-assets/images/portrait/small/avatar-s-9.png') }}" alt="Generic placeholder image">
                                                                </div>
                                                                <div class="media-body">
                                                                    Sometimes life is going to hit you in the head with a brick. Don't lose faith.
                                                                </div>
    ...
    <script src="{{ asset('app-assets/vendors/js/charts/chartist.min.js') }}"
    <script src="{{ asset('app-assets/vendors/js/charts/chartist-plugin-tooltip.min.js') }}"
    <script src="{{ asset('app-assets/vendors/js/charts/raphael-min.js') }}"
    <script src="{{ asset('app-assets/vendors/js/charts/morris.min.js') }}"
    <script src="{{ asset('app-assets/vendors/js/timeline/horizontal-timeline.js') }}"
    <!-- END: Page Vendor JS-->

    <!-- BEGIN: Theme JS-->
    <script src="{{ asset('app-assets/js/core/app-menu.js') }}"
    <script src="{{ asset('app-assets/js/core/app.js') }}"
    <!-- END: Theme JS-->

    <!-- BEGIN: Page JS-->
    <script src="{{ asset('app-assets/js/scripts/pages/dashboard-ecommerce.js') }}"
    <!-- END: Page JS-->
    @livewireScripts
</body>
<!-- END: Body-->
